#!/usr/bin/env python3
"""
Standalone Microservice Webhook Adapter for sovereign-rpa-auth-agent
Listens on port 8788 and translates n8n requests into deterministic engine executions.
"""
import sys
import os
import json
...
def run():
    server = HTTPServer(("0.0.0.0", 8788), WebhookHandler)
    print(f"[Sovereign Rpa Auth Agent] Webhook Adapter listening on http://0.0.0.0:8788")
