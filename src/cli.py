#!/usr/bin/env python3
"""
CLI entrypoint for sovereign-rpa-auth-agent
"""
import sys
import json
import argparse
...
def main():
    parser = argparse.ArgumentParser(description="Headless browser authentication agent using Model Context Protocol (MCP). Solves persistent login failures on legacy enterprise portals lacking APIs, managing encrypted session vaults, MFA timing loops, and automated form submissions.")
